# Usage Guide: 🤖 AI Powered RAG Chatbot for Your Docs + Google Drive + Gemini + Qdrant
...
This workflow consists of 75 nodes with the following execution flow:

1. **Trigger**: Workflow starts with n8n-nodes-base.manualTrigger, n8n-nodes-base.webhook, @n8n/n8n-nodes-langchain.chatTrigger
2. **Processing**: Data flows through 72 processing nodes
3. **Integration**: Connects with Google, Google, Google, Google, Google, Google
