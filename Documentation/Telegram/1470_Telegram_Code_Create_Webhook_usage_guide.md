# Usage Guide: Generate Instagram Content from Top Trends with AI Image Generation
...
This workflow consists of 97 nodes with the following execution flow:

1. **Trigger**: Workflow starts with n8n-nodes-base.scheduleTrigger
2. **Processing**: Data flows through 96 processing nodes
