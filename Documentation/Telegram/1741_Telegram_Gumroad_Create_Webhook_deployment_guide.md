# Deployment Guide: 2. Add Beehiiv newsletter subscribers from Gumroad sales
...
- **gumroadApi**: [Instructions for setting up gumroadApi]
- **telegramApi**: [Instructions for setting up telegramApi]
- **httpBearerAuth**: [Instructions for setting up httpBearerAuth]
