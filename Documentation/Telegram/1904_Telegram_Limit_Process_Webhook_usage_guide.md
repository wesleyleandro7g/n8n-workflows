# Usage Guide: ✨🔪 Advanced AI Powered Document Parsing & Text Extraction with Llama Parse
...
1. **Trigger**: Workflow starts with n8n-nodes-base.webhook, n8n-nodes-base.gmailTrigger
2. **Processing**: Data flows through 88 processing nodes
