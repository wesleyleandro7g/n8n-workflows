# Usage Guide: 🧠 Give Your AI Agent Chatbot Long Term Memory Tools Router
...
This workflow consists of 52 nodes with the following execution flow:

1. **Trigger**: Workflow starts with n8n-nodes-base.executeWorkflowTrigger, @n8n/n8n-nodes-langchain.chatTrigger
2. **Processing**: Data flows through 50 processing nodes
3. **Integration**: Connects with Google, Google, Google, Google
