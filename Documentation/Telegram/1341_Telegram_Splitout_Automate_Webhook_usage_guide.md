# Usage Guide: Automated Research Report Generation with OpenAI, Wikipedia, Google Search, and Gmail/Telegram
...
This workflow consists of 72 nodes with the following execution flow:

1. **Trigger**: Workflow starts with n8n-nodes-base.manualTrigger, n8n-nodes-base.executeWorkflowTrigger
2. **Processing**: Data flows through 70 processing nodes
