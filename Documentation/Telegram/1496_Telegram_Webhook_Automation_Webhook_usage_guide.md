# Usage Guide: 🔍🛠️Perplexity Researcher to HTML Web Page
...
This workflow consists of 77 nodes with the following execution flow:
...
2. **Processing**: Data flows through 74 processing nodes
