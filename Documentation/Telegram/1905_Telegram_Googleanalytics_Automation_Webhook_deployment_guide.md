# Deployment Guide: Online Marketing Weekly Report
...
- **googleAnalyticsOAuth2**: [Instructions for setting up googleAnalyticsOAuth2]
- **googleOAuth2Api**: [Instructions for setting up googleOAuth2Api]
- **facebookGraphApi**: [Instructions for setting up facebookGraphApi]
- **googleAdsOAuth2Api**: [Instructions for setting up googleAdsOAuth2Api]
- **smtp**: [Instructions for setting up smtp]
