# Usage Guide: e-mail Chatbot with both semantic and structured RAG, using Telegram and Pgvector
...
1. **Trigger**: Workflow starts with n8n-nodes-base.telegramTrigger, @n8n/n8n-nodes-langchain.chatTrigger
