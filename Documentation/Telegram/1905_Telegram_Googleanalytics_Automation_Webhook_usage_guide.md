# Usage Guide: Online Marketing Weekly Report
...
This workflow consists of 93 nodes with the following execution flow:

1. **Trigger**: Workflow starts with n8n-nodes-base.scheduleTrigger, n8n-nodes-base.executeWorkflowTrigger
2. **Processing**: Data flows through 91 processing nodes
