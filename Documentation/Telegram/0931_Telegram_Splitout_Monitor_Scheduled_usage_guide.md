# Usage Guide: N8N Financial Tracker Telegram Invoices to Notion with AI Summaries & Reports
...
1. **Trigger**: Workflow starts with n8n-nodes-base.scheduleTrigger, n8n-nodes-base.telegramTrigger
