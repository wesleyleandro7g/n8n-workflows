# Usage Guide: 🦜✨Use OpenAI to Transcribe Audio + Summarize with AI + Save to Google Drive
...
1. **Trigger**: Workflow starts with n8n-nodes-base.manualTrigger, n8n-nodes-base.googleDriveTrigger
