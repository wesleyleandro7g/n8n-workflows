# Deployment Guide: All-in-One Telegram/Baserow AI Assistant 🤖🧠 Voice/Photo/Save Notes/Long Term Mem
...
- **baserowApi**: [Instructions for setting up baserowApi]
...
- **Path**: `gram`
- **Method**: `POST`
- **URL**: `https://your-n8n-instance/webhook/gram`
