# Usage Guide: 💥AI Social Video Generator with GPT-4, Kling & Blotato —Auto-Post to Instagram, Facebook,, TikTok...
...
This workflow consists of 154 nodes with the following execution flow:

1. **Trigger**: Workflow starts with n8n-nodes-base.telegramTrigger
2. **Processing**: Data flows through 153 processing nodes
