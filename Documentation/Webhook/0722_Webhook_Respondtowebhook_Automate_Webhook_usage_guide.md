# Usage Guide: Automate Drive-To-Store Lead Generation System (with coupon) on SuiteCRM
...
This workflow consists of 54 nodes with the following execution flow:

1. **Trigger**: Workflow starts with n8n-nodes-base.webhook, n8n-nodes-base.formTrigger, n8n-nodes-base.respondToWebhook, n8n-nodes-base.respondToWebhook
2. **Processing**: Data flows through 50 processing nodes
