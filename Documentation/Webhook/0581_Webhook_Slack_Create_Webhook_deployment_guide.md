# Deployment Guide: Venafitlsprotectcloud Workflow
...
- **venafiTlsProtectCloudApi**: [Instructions for setting up venafiTlsProtectCloudApi]
...
- **Path**: `venafiendpoint`
- **Method**: `POST`
- **URL**: `https://your-n8n-instance/webhook/venafiendpoint`
