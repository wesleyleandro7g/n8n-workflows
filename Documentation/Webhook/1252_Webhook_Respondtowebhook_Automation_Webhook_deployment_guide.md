# Deployment Guide: AI Agent to chat with you Search Console Data, using OpenAI and Postgres
...
- **oAuth2Api**: [Instructions for setting up oAuth2Api]
- **postgres**: [Instructions for setting up postgres]
...
- **Method**: `POST`
- **URL**: `https://your-n8n-instance/webhook/a6820b65-76cf-402b-a934-0f836dee6ba0/chat`
