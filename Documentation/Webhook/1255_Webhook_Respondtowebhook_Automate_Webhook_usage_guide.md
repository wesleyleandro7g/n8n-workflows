# Usage Guide: Stock Q&A Workflow
...
1. **Trigger**: Workflow starts with @n8n/n8n-nodes-langchain.manualChatTrigger, n8n-nodes-base.respondToWebhook, n8n-nodes-base.webhook, n8n-nodes-base.manualTrigger
