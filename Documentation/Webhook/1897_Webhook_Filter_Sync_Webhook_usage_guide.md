# Usage Guide: Realtime Notion Todoist 2-way Sync Template
...
This workflow consists of 341 nodes with the following execution flow:

1. **Trigger**: Workflow starts with n8n-nodes-base.webhook, n8n-nodes-base.respondToWebhook, n8n-nodes-base.respondToWebhook, n8n-nodes-base.formTrigger, n8n-nodes-base.formTrigger, n8n-nodes-base.scheduleTrigger, n8n-nodes-base.executeWorkflowTrigger, n8n-nodes-base.webhook, n8n-nodes-base.webhook, n8n-nodes-base.webhook
2. **Processing**: Data flows through 331 processing nodes
