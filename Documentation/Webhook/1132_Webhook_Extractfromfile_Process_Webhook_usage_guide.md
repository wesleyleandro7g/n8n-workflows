# Usage Guide: Convert Squarespace Profiles to Shopify Customers in Google Sheets
...
This workflow consists of 23 nodes with the following execution flow:

1. **Trigger**: Workflow starts with n8n-nodes-base.webhook, n8n-nodes-base.manualTrigger
