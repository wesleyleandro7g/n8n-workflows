# Usage Guide: Unique QRcode coupon assignment and validation for Lead Generation system
...
This workflow consists of 98 nodes with the following execution flow:

1. **Trigger**: Workflow starts with n8n-nodes-base.webhook, n8n-nodes-base.formTrigger, n8n-nodes-base.respondToWebhook, n8n-nodes-base.respondToWebhook, n8n-nodes-base.respondToWebhook
