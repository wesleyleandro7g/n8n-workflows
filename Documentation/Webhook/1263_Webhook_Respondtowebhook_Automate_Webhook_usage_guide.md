# Usage Guide: Voice RAG Chatbot with ElevenLabs and OpenAI
...
This workflow consists of 58 nodes with the following execution flow:

1. **Trigger**: Workflow starts with n8n-nodes-base.manualTrigger, n8n-nodes-base.respondToWebhook, n8n-nodes-base.webhook
