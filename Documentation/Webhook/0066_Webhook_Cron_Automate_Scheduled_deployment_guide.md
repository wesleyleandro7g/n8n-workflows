# Deployment Guide: Standup Bot - Worker
...
- **Method**: `POST`
- **URL**: `https://your-n8n-instance/webhook/standup-bot/action/f6f9b174745fa4651f750c36957d674c`

- **Path**: `standup-bot/slashCmd`
- **Method**: `POST`
- **URL**: `https://your-n8n-instance/webhook/standup-bot/slashCmd`
