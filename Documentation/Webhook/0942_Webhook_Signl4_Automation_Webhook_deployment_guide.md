...
- **signl4Api**: [Instructions for setting up signl4Api]
- **theHiveApi**: [Instructions for setting up theHiveApi]
...
- **Method**: `POST`
- **URL**: `https://your-n8n-instance/webhook/22c76955-3f52-469e-a8ae-3f62e8e87ebe`
