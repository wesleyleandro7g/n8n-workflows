# Deployment Guide: Lemlist Workflow
...
- **hubspotOAuth2Api**: [Instructions for setting up hubspotOAuth2Api]
- **lemlistApi**: [Instructions for setting up lemlistApi]
- **dropcontactApi**: [Instructions for setting up dropcontactApi]
...
- **Method**: `POST`
- **URL**: `https://your-n8n-instance/webhook/fe426a62-eee5-4fed-bc74-45d4ac09b338-lonescale`
