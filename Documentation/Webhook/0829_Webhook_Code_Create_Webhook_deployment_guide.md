...
- **Path**: `getslots`
- **Method**: `POST`
- **URL**: `https://your-n8n-instance/webhook/getslots`

- **Path**: `bookslots`
- **Method**: `POST`
- **URL**: `https://your-n8n-instance/webhook/bookslots`

- **Path**: `updateslots`
- **Method**: `POST`
- **URL**: `https://your-n8n-instance/webhook/updateslots`

- **Path**: `cancelslots`
- **Method**: `POST`
- **URL**: `https://your-n8n-instance/webhook/cancelslots`

- **Path**: `callresults`
- **Method**: `POST`
- **URL**: `https://your-n8n-instance/webhook/callresults`
