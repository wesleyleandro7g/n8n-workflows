# Deployment Guide: Dynamically generate HTML page from user request using OpenAI Structured Output
...
- **Method**: `POST`
- **URL**: `https://your-n8n-instance/webhook/d962c916-6369-431a-9d80-af6e6a50fdf5`
