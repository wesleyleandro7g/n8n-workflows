# Usage Guide: Venafitlsprotectcloud Workflow
...
This workflow consists of 83 nodes with the following execution flow:

1. **Trigger**: Workflow starts with n8n-nodes-base.respondToWebhook, n8n-nodes-base.respondToWebhook, n8n-nodes-base.webhook, n8n-nodes-base.respondToWebhook
2. **Processing**: Data flows through 79 processing nodes
