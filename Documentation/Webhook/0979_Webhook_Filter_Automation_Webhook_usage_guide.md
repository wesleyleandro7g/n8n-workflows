# Usage Guide: comentarios automaticos
...
1. **Trigger**: Workflow starts with n8n-nodes-base.webhook, n8n-nodes-base.respondToWebhook, n8n-nodes-base.webhook
2. **Processing**: Data flows through 46 processing nodes
