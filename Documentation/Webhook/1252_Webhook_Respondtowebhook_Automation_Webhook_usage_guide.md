# Usage Guide: AI Agent to chat with you Search Console Data, using OpenAI and Postgres
...
This workflow consists of 60 nodes with the following execution flow:

1. **Trigger**: Workflow starts with n8n-nodes-base.webhook, n8n-nodes-base.respondToWebhook, n8n-nodes-base.executeWorkflowTrigger
