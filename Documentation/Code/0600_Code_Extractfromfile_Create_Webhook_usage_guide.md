...
This workflow consists of 82 nodes with the following execution flow:

1. **Trigger**: Workflow starts with n8n-nodes-base.manualTrigger, n8n-nodes-base.executeWorkflowTrigger, n8n-nodes-base.airtableTrigger, @n8n/n8n-nodes-langchain.chatTrigger
2. **Processing**: Data flows through 78 processing nodes
