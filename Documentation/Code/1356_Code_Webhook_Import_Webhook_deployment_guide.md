# Deployment Guide: Bitrix24 Task Form Widget Application Workflow example with Webhook Integration
...
- **Method**: `POST`
- **URL**: `https://your-n8n-instance/webhook/bitrix24/widgethandler.php`
