# Deployment Guide: Googlesheets Workflow
...
- **Path**: `/approve-issue`
- **Method**: `POST`
- **URL**: `https://your-n8n-instance/webhook//approve-issue`

- **Path**: `raw-materials-issue`
- **Method**: `POST`
- **URL**: `https://your-n8n-instance/webhook/raw-materials-issue`

- **Path**: `Pb-raw-materials`
- **Method**: `POST`
- **URL**: `https://your-n8n-instance/webhook/Pb-raw-materials`
