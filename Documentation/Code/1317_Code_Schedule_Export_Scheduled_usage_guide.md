# Usage Guide: 🧹 Archive (delete) duplicate items from a Notion database
...
1. **Trigger**: Workflow starts with n8n-nodes-base.scheduleTrigger, n8n-nodes-base.notionTrigger
