# Deployment Guide: Workflow stats
...
- **n8nApi**: [Instructions for setting up n8nApi]
...
- **Method**: `POST`
- **URL**: `https://your-n8n-instance/webhook/fb550a01-12f2-4709-ba2d-f71197b68340`

- **Path**: `73a91e4d-143d-4168-9efb-6c56f2258aec/dashboard.xsl`
- **Method**: `POST`
- **URL**: `https://your-n8n-instance/webhook/73a91e4d-143d-4168-9efb-6c56f2258aec/dashboard.xsl`
