...
1. **Trigger**: Workflow starts with n8n-nodes-base.manualTrigger, n8n-nodes-base.scheduleTrigger, n8n-nodes-base.executeWorkflowTrigger
2. **Processing**: Data flows through 31 processing nodes
3. **Integration**: Connects with Github, Github, Github
