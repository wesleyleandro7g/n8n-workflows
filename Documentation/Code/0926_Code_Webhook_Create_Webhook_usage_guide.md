# Usage Guide: Googlesheets Workflow
...
This workflow consists of 86 nodes with the following execution flow:

1. **Trigger**: Workflow starts with n8n-nodes-base.webhook, n8n-nodes-base.webhook, n8n-nodes-base.webhook
2. **Processing**: Data flows through 83 processing nodes
3. **Integration**: Connects with Google, Google, Google, Google, Google, Google, Google, Google, Google, Google, Google, Google
