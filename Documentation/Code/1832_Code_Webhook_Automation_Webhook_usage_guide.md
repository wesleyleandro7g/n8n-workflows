# Usage Guide: PUQ Docker NextCloud deploy
...
This workflow consists of 85 nodes with the following execution flow:

1. **Trigger**: Workflow starts with n8n-nodes-base.webhook, n8n-nodes-base.respondToWebhook, n8n-nodes-base.respondToWebhook, n8n-nodes-base.respondToWebhook
2. **Processing**: Data flows through 81 processing nodes
