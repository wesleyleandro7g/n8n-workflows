# Deployment Guide: [1/3 - anomaly detection] [1/2 - KNN classification] Batch upload dataset to Qdrant (crops dataset)
...
- **googleCloudStorageOAuth2Api**: [Instructions for setting up googleCloudStorageOAuth2Api]
