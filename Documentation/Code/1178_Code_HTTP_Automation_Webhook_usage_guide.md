# Usage Guide: Publish Videos & Images - Blotato
...
This workflow consists of 108 nodes with the following execution flow:

1. **Trigger**: Workflow starts with n8n-nodes-base.manualTrigger, n8n-nodes-base.formTrigger
2. **Processing**: Data flows through 106 processing nodes
