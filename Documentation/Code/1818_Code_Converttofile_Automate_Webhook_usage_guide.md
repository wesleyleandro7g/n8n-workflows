...
This workflow consists of 67 nodes with the following execution flow:

1. **Trigger**: Workflow starts with n8n-nodes-base.formTrigger, @n8n/n8n-nodes-langchain.chatTrigger
2. **Processing**: Data flows through 65 processing nodes
