# Usage Guide: Memorybufferwindow Workflow
...
1. **Trigger**: Workflow starts with n8n-nodes-base.respondToWebhook, n8n-nodes-base.executeWorkflowTrigger, @n8n/n8n-nodes-langchain.chatTrigger, n8n-nodes-base.respondToWebhook
2. **Processing**: Data flows through 50 processing nodes
3. **Integration**: Connects with Microsoft
