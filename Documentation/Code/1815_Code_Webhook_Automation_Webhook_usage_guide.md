# Usage Guide: puq-docker-influxdb-deploy
...
This workflow consists of 56 nodes with the following execution flow:

1. **Trigger**: Workflow starts with n8n-nodes-base.webhook, n8n-nodes-base.respondToWebhook, n8n-nodes-base.respondToWebhook
2. **Processing**: Data flows through 53 processing nodes
