...
- **mySql**: [Instructions for setting up mySql]
...
- **pineconeApi**: [Instructions for setting up pineconeApi]
- **groqApi**: [Instructions for setting up groqApi]
...
- **Path**: `radar-rag`
- **Method**: `POST`
- **URL**: `https://your-n8n-instance/webhook/radar-rag`
