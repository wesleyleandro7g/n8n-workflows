...
This workflow consists of 40 nodes with the following execution flow:

1. **Trigger**: Workflow starts with n8n-nodes-base.manualTrigger, n8n-nodes-base.executeWorkflowTrigger, n8n-nodes-base.scheduleTrigger
2. **Processing**: Data flows through 37 processing nodes
3. **Integration**: Connects with Github, Github, Slack, Slack, Slack, Github
