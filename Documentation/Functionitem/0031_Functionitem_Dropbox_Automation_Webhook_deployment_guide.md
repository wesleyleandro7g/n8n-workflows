...
- **aws**: [Instructions for setting up aws]
- **uprocApi**: [Instructions for setting up uprocApi]
- **dropboxApi**: [Instructions for setting up dropboxApi]
