# Usage Guide: Google calendar to Outlook
...
1. **Trigger**: Workflow starts with n8n-nodes-base.googleCalendarTrigger, n8n-nodes-base.googleCalendarTrigger
2. **Processing**: Data flows through 13 processing nodes
3. **Integration**: Connects with Google, Google, Microsoft, Microsoft, Microsoft, Microsoft
