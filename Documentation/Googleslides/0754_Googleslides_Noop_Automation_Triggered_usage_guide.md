# Usage Guide: DSP Certificate w/ Google Forms
...
This workflow consists of 26 nodes with the following execution flow:

1. **Trigger**: Workflow starts with n8n-nodes-base.googleSheetsTrigger
2. **Processing**: Data flows through 25 processing nodes
