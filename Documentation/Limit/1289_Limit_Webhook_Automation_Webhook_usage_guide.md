# Usage Guide: AI Voice Chat using Webhook, Memory Manager, OpenAI, Google Gemini & ElevenLabs
...
1. **Trigger**: Workflow starts with n8n-nodes-base.respondToWebhook, n8n-nodes-base.webhook
