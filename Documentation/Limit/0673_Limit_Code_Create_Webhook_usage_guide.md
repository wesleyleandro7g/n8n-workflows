# Usage Guide: Microsoftoutlooktrigger Workflow
...
This workflow consists of 76 nodes with the following execution flow:

1. **Trigger**: Workflow starts with n8n-nodes-base.microsoftOutlookTrigger, n8n-nodes-base.respondToWebhook, n8n-nodes-base.webhook
