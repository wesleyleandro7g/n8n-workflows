# Usage Guide: Receive updates when an event occurs in TheHive
...
This workflow consists of 6 nodes with the following execution flow:

1. **Trigger**: Workflow starts with n8n-nodes-base.theHiveTrigger
2. **Processing**: Data flows through 5 processing nodes
