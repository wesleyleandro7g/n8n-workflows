# Usage Guide: template-demo-chatgpt-image-1-with-drive-and-sheet copy
...
1. **Trigger**: Workflow starts with n8n-nodes-base.manualTrigger, @n8n/n8n-nodes-langchain.chatTrigger
