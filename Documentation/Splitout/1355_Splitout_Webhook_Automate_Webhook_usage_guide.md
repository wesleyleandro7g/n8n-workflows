# Usage Guide: Bitrix24 Open Chanel RAG Chatbot Application Workflow example with Webhook Integration
...
This workflow consists of 106 nodes with the following execution flow:

1. **Trigger**: Workflow starts with n8n-nodes-base.webhook, n8n-nodes-base.respondToWebhook, n8n-nodes-base.respondToWebhook, n8n-nodes-base.executeWorkflowTrigger
2. **Processing**: Data flows through 102 processing nodes
