# Usage Guide: Googlesheetstrigger Workflow
...
This workflow consists of 64 nodes with the following execution flow:

1. **Trigger**: Workflow starts with n8n-nodes-base.googleSheetsTrigger, n8n-nodes-base.scheduleTrigger
2. **Processing**: Data flows through 62 processing nodes
3. **Integration**: Connects with Google, Google, Google, Google, Slack, Google, Slack, Google
