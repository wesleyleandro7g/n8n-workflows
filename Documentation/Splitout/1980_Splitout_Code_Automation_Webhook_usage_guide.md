# Usage Guide: Auto-Tag Blog Posts in WordPress with AI
...
1. **Trigger**: Workflow starts with n8n-nodes-base.rssFeedReadTrigger, n8n-nodes-base.executeWorkflowTrigger
