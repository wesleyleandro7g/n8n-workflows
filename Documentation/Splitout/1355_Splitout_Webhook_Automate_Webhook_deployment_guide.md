# Deployment Guide: Bitrix24 Open Chanel RAG Chatbot Application Workflow example with Webhook Integration
...
- **Method**: `POST`
- **URL**: `https://your-n8n-instance/webhook/bitrix24/openchannel-rag-bothandler.php`
