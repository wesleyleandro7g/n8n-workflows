# Usage Guide: BambooHR AI-Powered Company Policies and Benefits Chatbot
...
This workflow consists of 63 nodes with the following execution flow:
...
2. **Processing**: Data flows through 60 processing nodes
