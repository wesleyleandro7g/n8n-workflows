# Usage Guide: Extract spend details (template)
...
1. **Trigger**: Workflow starts with n8n-nodes-base.gmailTrigger, n8n-nodes-base.gmailTrigger
2. **Processing**: Data flows through 32 processing nodes
