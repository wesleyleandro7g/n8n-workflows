# Usage Guide: Building RAG Chatbot for Movie Recommendations with Qdrant and Open AI
...
This workflow consists of 59 nodes with the following execution flow:

1. **Trigger**: Workflow starts with n8n-nodes-base.manualTrigger, @n8n/n8n-nodes-langchain.chatTrigger, n8n-nodes-base.executeWorkflowTrigger
2. **Processing**: Data flows through 56 processing nodes
3. **Integration**: Connects with Github
