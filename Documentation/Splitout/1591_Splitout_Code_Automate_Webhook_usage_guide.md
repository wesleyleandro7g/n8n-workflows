# Usage Guide: n8n Subworkflow Dependency Graph & Auto-Tagging
...
This workflow consists of 81 nodes with the following execution flow:

1. **Trigger**: Workflow starts with n8n-nodes-base.scheduleTrigger, n8n-nodes-base.n8nTrigger, n8n-nodes-base.webhook, n8n-nodes-base.respondToWebhook
2. **Processing**: Data flows through 77 processing nodes
