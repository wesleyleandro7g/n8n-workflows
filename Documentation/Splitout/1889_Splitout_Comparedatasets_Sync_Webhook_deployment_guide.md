# Deployment Guide: Entra Contacts to Zammad User Sync
...
- **microsoftOAuth2Api**: [Instructions for setting up microsoftOAuth2Api]
- **microsoftGraphSecurityOAuth2Api**: [Instructions for setting up microsoftGraphSecurityOAuth2Api]
