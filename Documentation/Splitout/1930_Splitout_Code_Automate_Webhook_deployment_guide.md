# Deployment Guide: AI powered SEO Keyword Research Automation - The vibe Marketer
...
- **nocoDbApiToken**: [Instructions for setting up nocoDbApiToken]
- **dataForSeoApi**: [Instructions for setting up dataForSeoApi]
...
- **Method**: `POST`
- **URL**: `https://your-n8n-instance/webhook/ac7e989d-6e32-4850-83c4-f10421467fb8`
