# Usage Guide: Write a WordPress post with AI (starting from a few keywords)
...
This workflow consists of 69 nodes with the following execution flow:

1. **Trigger**: Workflow starts with n8n-nodes-base.formTrigger, n8n-nodes-base.respondToWebhook, n8n-nodes-base.respondToWebhook
2. **Processing**: Data flows through 66 processing nodes
