...
1. **Trigger**: Workflow starts with @n8n/n8n-nodes-langchain.mcpTrigger, n8n-nodes-base.executeWorkflowTrigger, n8n-nodes-base.manualTrigger
2. **Processing**: Data flows through 90 processing nodes
