# Usage Guide: [n8n] Advanced URL Parsing and Shortening Workflow - Switchy.io Integration
...
This workflow consists of 121 nodes with the following execution flow:
