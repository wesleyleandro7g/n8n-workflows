# Usage Guide: Notion to Clockify Sync Template
...
This workflow consists of 88 nodes with the following execution flow:

1. **Trigger**: Workflow starts with n8n-nodes-base.webhook, n8n-nodes-base.scheduleTrigger
