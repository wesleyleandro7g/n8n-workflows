# Deployment Guide: Notion to Clockify Sync Template
...
- **clockifyApi**: [Instructions for setting up clockifyApi]
...
- **Method**: `POST`
- **URL**: `https://your-n8n-instance/webhook/43028c1f-7331-4fbe-bf56-d6f47c92d9be`
