# Deployment Guide: 2. Refresh Pipedrive tokens
...
- **httpBasicAuth**: [Instructions for setting up httpBasicAuth]
- **supabaseApi**: [Instructions for setting up supabaseApi]
...
- **Method**: `POST`
- **URL**: `https://your-n8n-instance/webhook/937a8843-a28a-400a-b473-bdc598366fa0`

- **Path**: `47704458-bfa6-4d95-adf1-97fc78e35d8a`
- **Method**: `POST`
- **URL**: `https://your-n8n-instance/webhook/47704458-bfa6-4d95-adf1-97fc78e35d8a`

- **Path**: `aae545fb-a69d-4e20-91ce-65f105d0ea2f`
- **Method**: `POST`
- **URL**: `https://your-n8n-instance/webhook/aae545fb-a69d-4e20-91ce-65f105d0ea2f`
