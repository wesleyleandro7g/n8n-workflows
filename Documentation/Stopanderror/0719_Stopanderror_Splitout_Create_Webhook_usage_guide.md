# Usage Guide: Outputparserstructured Workflow
...
1. **Trigger**: Workflow starts with n8n-nodes-base.formTrigger, n8n-nodes-base.executeWorkflowTrigger
2. **Processing**: Data flows through 104 processing nodes
