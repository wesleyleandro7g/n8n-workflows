# Deployment Guide: Zoom AI Meeting Assistant
...
- **anthropicApi**: [Instructions for setting up anthropicApi]
- **smtp**: [Instructions for setting up smtp]
- **zoomOAuth2Api**: [Instructions for setting up zoomOAuth2Api]
- **microsoftOutlookOAuth2Api**: [Instructions for setting up microsoftOutlookOAuth2Api]
- **clickUpOAuth2Api**: [Instructions for setting up clickUpOAuth2Api]
