# Usage Guide: Generate Leads with Google Maps - AlexK1919
...
This workflow consists of 57 nodes with the following execution flow:
...
2. **Processing**: Data flows through 54 processing nodes
