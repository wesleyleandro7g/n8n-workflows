# Usage Guide: Manualchattrigger Workflow
...
This workflow consists of 18 nodes with the following execution flow:

1. **Trigger**: Workflow starts with @n8n/n8n-nodes-langchain.manualChatTrigger, n8n-nodes-base.executeWorkflowTrigger
2. **Processing**: Data flows through 16 processing nodes
