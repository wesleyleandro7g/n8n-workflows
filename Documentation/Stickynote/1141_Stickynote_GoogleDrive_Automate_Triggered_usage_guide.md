# Usage Guide: RAG Workflow For Company Documents stored in Google Drive
...
1. **Trigger**: Workflow starts with n8n-nodes-base.googleDriveTrigger, n8n-nodes-base.googleDriveTrigger, @n8n/n8n-nodes-langchain.chatTrigger
2. **Processing**: Data flows through 27 processing nodes
