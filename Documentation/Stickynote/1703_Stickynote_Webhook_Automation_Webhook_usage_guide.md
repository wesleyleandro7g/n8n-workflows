# Usage Guide: Travel Planning Agent with Couchbase Vector Search, Gemini 2.0 Flash and OpenAI
...
1. **Trigger**: Workflow starts with @n8n/n8n-nodes-langchain.chatTrigger, n8n-nodes-base.webhook
