# Usage Guide: Deep Research Report Generation Using Open Router, Google Search, Webhook/Telegram and Notion
...
1. **Trigger**: Workflow starts with n8n-nodes-base.telegramTrigger, n8n-nodes-base.webhook, n8n-nodes-base.respondToWebhook, n8n-nodes-base.respondToWebhook
2. **Processing**: Data flows through 85 processing nodes
