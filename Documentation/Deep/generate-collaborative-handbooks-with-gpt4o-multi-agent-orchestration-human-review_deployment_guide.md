# Deployment Guide: Pyragogy AI Village - Orchestrazione Master (Architettura Profonda V2)
...
- **emailSend**: [Instructions for setting up emailSend]
- **githubApi**: [Instructions for setting up githubApi]
...
- **Method**: `POST`
- **URL**: `https://your-n8n-instance/webhook/pyragogy/process`
