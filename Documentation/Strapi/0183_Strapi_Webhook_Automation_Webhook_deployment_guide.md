...
- **strapiApi**: [Instructions for setting up strapiApi]
- **googleCloudNaturalLanguageOAuth2Api**: [Instructions for setting up googleCloudNaturalLanguageOAuth2Api]
- **twitterOAuth1Api**: [Instructions for setting up twitterOAuth1Api]
...
- **Method**: `POST`
- **URL**: `https://your-n8n-instance/webhook/6f833370-9068-44ef-8e56-4ceb563a851e`
