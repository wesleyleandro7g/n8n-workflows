# Usage Guide: Slack AI Chatbot with RAG for company staff
...
This workflow consists of 44 nodes with the following execution flow:

1. **Trigger**: Workflow starts with n8n-nodes-base.slackTrigger, n8n-nodes-base.manualTrigger
2. **Processing**: Data flows through 42 processing nodes
3. **Integration**: Connects with Slack, Slack, Google, Google
