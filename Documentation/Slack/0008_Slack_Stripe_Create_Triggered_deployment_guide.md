# Deployment Guide: On new Stripe Invoice Payment update Hubspot and notify the team in Slack
...
- **hubspotApi**: [Instructions for setting up hubspotApi]
- **stripeApi**: [Instructions for setting up stripeApi]
