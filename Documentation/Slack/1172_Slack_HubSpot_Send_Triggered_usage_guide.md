# Usage Guide: Check for valid Hubspot contact email
...
This workflow consists of 5 nodes with the following execution flow:

1. **Trigger**: Workflow starts with n8n-nodes-base.hubspotTrigger
2. **Processing**: Data flows through 4 processing nodes
3. **Integration**: Connects with Hubspot, Hubspot, Slack
