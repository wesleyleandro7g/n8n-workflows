# Usage Guide: On new Stripe Invoice Payment update Hubspot and notify the team in Slack
...
This workflow consists of 13 nodes with the following execution flow:

1. **Trigger**: Workflow starts with n8n-nodes-base.stripeTrigger
2. **Processing**: Data flows through 12 processing nodes
3. **Integration**: Connects with Stripe, Hubspot, Hubspot, Slack, Slack, Slack
