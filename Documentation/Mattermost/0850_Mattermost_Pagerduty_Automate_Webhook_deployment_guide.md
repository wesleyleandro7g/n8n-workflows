...
- **pagerDutyApi**: [Instructions for setting up pagerDutyApi]
- **mattermostApi**: [Instructions for setting up mattermostApi]
...
- **Path**: `/ack`
- **Method**: `POST`
- **URL**: `https://your-n8n-instance/webhook//ack`

- **Path**: `/resolve`
- **Method**: `POST`
- **URL**: `https://your-n8n-instance/webhook//resolve`

- **Path**: `9888d896-dd23-4e97-9d16-c12055b64133`
- **Method**: `POST`
- **URL**: `https://your-n8n-instance/webhook/9888d896-dd23-4e97-9d16-c12055b64133`
