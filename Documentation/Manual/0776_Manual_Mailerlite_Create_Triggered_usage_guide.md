# Usage Guide: Receive updates when a subscriber is added to a group and strore the information in Airtable
...
1. **Trigger**: Workflow starts with n8n-nodes-base.manualTrigger, n8n-nodes-base.mailerLiteTrigger
