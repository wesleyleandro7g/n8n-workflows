# Deployment Guide: Receive updates when a subscriber is added to a group and strore the information in Airtable
...
- **mailerLiteApi**: [Instructions for setting up mailerLiteApi]
