# Deployment Guide: Create a new list, add a new contact to the list, update the contact, and get all contacts in the...
...
- **automizyApi**: [Instructions for setting up automizyApi]
