# Usage Guide: Google Calendar to Slack Status & Philips Hue
...
1. **Trigger**: Workflow starts with n8n-nodes-base.manualTrigger, n8n-nodes-base.googleCalendarTrigger
