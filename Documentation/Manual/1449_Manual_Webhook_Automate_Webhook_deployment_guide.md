# Deployment Guide: NetSuite Rest API workflow
...
- **netsuite**: [Instructions for setting up netsuite]
...
- **Method**: `POST`
- **URL**: `https://your-n8n-instance/webhook/249328cc-587a-4269-b266-96fe60cfaeb9`
