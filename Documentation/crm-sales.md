...
* Webhook-triggered automation that orchestrates Shopify, Trello, and Mailchimp to create new records. Uses 9 nodes and integrates with 6 services.  
**Status:*
