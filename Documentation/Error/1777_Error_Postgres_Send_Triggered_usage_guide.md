# Usage Guide: Log errors and avoid sending too many emails
...
1. **Trigger**: Workflow starts with n8n-nodes-base.errorTrigger, n8n-nodes-base.manualTrigger, n8n-nodes-base.executeWorkflowTrigger
