# Deployment Guide: Build a Phone Agent to qualify outbound leads and inbound calls with RetellAI -vide
...
- **googleSheetsTriggerOAuth2Api**: [Instructions for setting up googleSheetsTriggerOAuth2Api]
...
- **Method**: `POST`
- **URL**: `https://your-n8n-instance/webhook/ebd11c9b-129c-4b59-8c27-9a4b567305f7`

- **Path**: `f8878b78-43ea-4caa-b16c-cde9aaf2e9b1`
- **Method**: `POST`
- **URL**: `https://your-n8n-instance/webhook/f8878b78-43ea-4caa-b16c-cde9aaf2e9b1`
