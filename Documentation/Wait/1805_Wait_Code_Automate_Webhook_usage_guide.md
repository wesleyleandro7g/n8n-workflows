# Usage Guide: AI Automated TikTok/Youtube Shorts/Reels Generator
...
This workflow consists of 104 nodes with the following execution flow:

1. **Trigger**: Workflow starts with n8n-nodes-base.scheduleTrigger
2. **Processing**: Data flows through 103 processing nodes
