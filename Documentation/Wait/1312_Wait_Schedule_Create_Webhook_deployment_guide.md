# Deployment Guide: Analyze_Crowdstrike_Detections__search_for_IOCs_in_VirusTotal__create_a_ticket_in_Jira_and_post_a...
...
- **jiraSoftwareCloudApi**: [Instructions for setting up jiraSoftwareCloudApi]
- **virusTotalApi**: [Instructions for setting up virusTotalApi]
- **slackOAuth2Api**: [Instructions for setting up slackOAuth2Api]
- **crowdStrikeOAuth2Api**: [Instructions for setting up crowdStrikeOAuth2Api]
