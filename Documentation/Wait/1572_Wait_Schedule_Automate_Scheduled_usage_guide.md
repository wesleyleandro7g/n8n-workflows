# Usage Guide: WhatsApp business bot
...
This workflow consists of 24 nodes with the following execution flow:

1. **Trigger**: Workflow starts with n8n-nodes-base.whatsAppTrigger, n8n-nodes-base.scheduleTrigger, n8n-nodes-base.googleSheetsTrigger
