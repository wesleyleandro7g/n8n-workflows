# Usage Guide: OpenAI Assistant for Hubspot Chat
...
This workflow consists of 112 nodes with the following execution flow:

1. **Trigger**: Workflow starts with n8n-nodes-base.webhook
2. **Processing**: Data flows through 111 processing nodes
