# Usage Guide: Build a Phone Agent to qualify outbound leads and inbound calls with RetellAI -vide
...
This workflow consists of 51 nodes with the following execution flow:

1. **Trigger**: Workflow starts with n8n-nodes-base.googleSheetsTrigger, n8n-nodes-base.webhook, n8n-nodes-base.respondToWebhook, n8n-nodes-base.webhook
