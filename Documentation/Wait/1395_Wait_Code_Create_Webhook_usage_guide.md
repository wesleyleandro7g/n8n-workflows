# Usage Guide: Create Animated Stories using GPT-4o-mini, Midjourney, Kling and Creatomate API
...
This workflow consists of 110 nodes with the following execution flow:

1. **Trigger**: Workflow starts with n8n-nodes-base.manualTrigger
2. **Processing**: Data flows through 109 processing nodes
