# Deployment Guide: Zohocrm Workflow
...
- **harvestApi**: [Instructions for setting up harvestApi]
- **trelloApi**: [Instructions for setting up trelloApi]
- **gmailOAuth2**: [Instructions for setting up gmailOAuth2]
- **zohoOAuth2Api**: [Instructions for setting up zohoOAuth2Api]
- **shopifyApi**: [Instructions for setting up shopifyApi]
