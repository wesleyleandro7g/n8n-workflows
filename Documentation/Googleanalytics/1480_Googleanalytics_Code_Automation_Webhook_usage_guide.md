# Usage Guide: Google analytics template
...
1. **Trigger**: Workflow starts with n8n-nodes-base.scheduleTrigger, n8n-nodes-base.manualTrigger
2. **Processing**: Data flows through 49 processing nodes
