# Deployment Guide: Training Feedback Automation
...
- **airtableOAuth2Api**: [Instructions for setting up airtableOAuth2Api]
...
- **Method**: `POST`
- **URL**: `https://your-n8n-instance/webhook/4ff46f8a-e1d0-4ad9-8dae-99de53838aaf`
