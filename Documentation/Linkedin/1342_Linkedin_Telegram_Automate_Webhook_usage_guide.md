# Usage Guide: ✨🩷Automated Social Media Content Publishing Factory + System Prompt Composition
...
This workflow consists of 159 nodes with the following execution flow:

1. **Trigger**: Workflow starts with @n8n/n8n-nodes-langchain.chatTrigger, n8n-nodes-base.executeWorkflowTrigger
2. **Processing**: Data flows through 157 processing nodes
