# Deployment Guide: ✨🩷Automated Social Media Content Publishing Factory + System Prompt Composition
...
- **linkedInOAuth2Api**: [Instructions for setting up linkedInOAuth2Api]
- **gmailOAuth2**: [Instructions for setting up gmailOAuth2]
- **googleDocsOAuth2Api**: [Instructions for setting up googleDocsOAuth2Api]
- **googleDriveOAuth2Api**: [Instructions for setting up googleDriveOAuth2Api]
- **facebookGraphApi**: [Instructions for setting up facebookGraphApi]
- **twitterOAuth2Api**: [Instructions for setting up twitterOAuth2Api]
- **serpApi**: [Instructions for setting up serpApi]
