# Usage Guide: Hacker News to Video Template - AlexK1919
...
This workflow consists of 147 nodes with the following execution flow:

1. **Trigger**: Workflow starts with n8n-nodes-base.manualTrigger
2. **Processing**: Data flows through 146 processing nodes
3. **Integration**: Connects with Google, Microsoft
