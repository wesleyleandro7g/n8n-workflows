# Deployment Guide: Shopify + Mautic
...
- **mauticOAuth2Api**: [Instructions for setting up mauticOAuth2Api]
- **shopifyAccessTokenApi**: [Instructions for setting up shopifyAccessTokenApi]
- **httpHeaderAuth**: [Instructions for setting up httpHeaderAuth]

### 2. Environment Variables
Set these environment variables:
- `API_ENDPOINT`: [Description of what this variable should contain]

### 3. Webhook Configuration
Configure webhook endpoints:
- **Path**: `6485fca6-c641-4067-b19a-192709b88e45`
- **Method**: `POST`
- **URL**: `https://your-n8n-instance/webhook/6485fca6-c641-4067-b19a-192709b88e45`
