# Usage Guide: AI-Generated Summary Block for WordPress Posts - with OpenAI, WordPress, Google Sheets & Slack
...
1. **Trigger**: Workflow starts with n8n-nodes-base.manualTrigger, n8n-nodes-base.webhook, n8n-nodes-base.scheduleTrigger
2. **Processing**: Data flows through 51 processing nodes
3. **Integration**: Connects with Google, Google, Slack
