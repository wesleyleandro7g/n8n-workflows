# Deployment Guide: MiniBear Webhook
...
- **microsoftOneDriveOAuth2Api**: [Instructions for setting up microsoftOneDriveOAuth2Api]
- **microsoftTeamsOAuth2Api**: [Instructions for setting up microsoftTeamsOAuth2Api]
- **httpHeaderAuth**: [Instructions for setting up httpHeaderAuth]
- **microsoftToDoOAuth2Api**: [Instructions for setting up microsoftToDoOAuth2Api]
- **openRouterApi**: [Instructions for setting up openRouterApi]
...
- **Path**: `minibear`
- **Method**: `POST`
- **URL**: `https://your-n8n-instance/webhook/minibear`
