# Usage Guide: Microsoft Outlook AI Email Assistant
...
This workflow consists of 34 nodes with the following execution flow:

1. **Trigger**: Workflow starts with n8n-nodes-base.manualTrigger, n8n-nodes-base.scheduleTrigger, n8n-nodes-base.scheduleTrigger
2. **Processing**: Data flows through 31 processing nodes
3. **Integration**: Connects with Microsoft, Microsoft, Microsoft
