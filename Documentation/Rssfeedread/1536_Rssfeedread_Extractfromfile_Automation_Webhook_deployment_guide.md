# Deployment Guide: YouTube Videos with AI Summaries on Discord
...
- **youTubeOAuth2Api**: [Instructions for setting up youTubeOAuth2Api]
- **openAiApi**: [Instructions for setting up openAiApi]
- **discordWebhookApi**: [Instructions for setting up discordWebhookApi]
