# Deployment Guide: Wordpress Form to Mautic
...
- **mauticApi**: [Instructions for setting up mauticApi]
...
- **Method**: `POST`
- **URL**: `https://your-n8n-instance/webhook/917366ee-14a8-4fef-9f0b-6638cdc35fad`
