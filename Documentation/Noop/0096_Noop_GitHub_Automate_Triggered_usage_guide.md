# Usage Guide: Automate assigning GitHub issues
...
1. **Trigger**: Workflow starts with n8n-nodes-base.githubTrigger
2. **Processing**: Data flows through 15 processing nodes
3. **Integration**: Connects with Github, Github, Github, Github
