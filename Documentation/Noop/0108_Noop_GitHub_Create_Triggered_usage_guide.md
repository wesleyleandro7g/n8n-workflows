# Usage Guide: Githubtrigger Workflow
...
This workflow consists of 17 nodes with the following execution flow:

1. **Trigger**: Workflow starts with n8n-nodes-base.githubTrigger, n8n-nodes-base.githubTrigger
2. **Processing**: Data flows through 15 processing nodes
3. **Integration**: Connects with Github, Github, Github, Github, Github
