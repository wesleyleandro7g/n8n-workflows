# Usage Guide: Extract text from PDF and image using Vertex AI (Gemini) into CSV
...
1. **Trigger**: Workflow starts with n8n-nodes-base.googleDriveTrigger
2. **Processing**: Data flows through 35 processing nodes
