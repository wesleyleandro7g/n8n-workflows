...
This workflow consists of 66 nodes with the following execution flow:

1. **Trigger**: Workflow starts with n8n-nodes-base.respondToWebhook, @n8n/n8n-nodes-langchain.chatTrigger, n8n-nodes-base.webhook
2. **Processing**: Data flows through 63 processing nodes
