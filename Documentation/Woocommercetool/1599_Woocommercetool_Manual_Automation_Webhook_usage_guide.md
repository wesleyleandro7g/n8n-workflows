# Usage Guide: OpenAI Personal Shopper with RAG and WooCommerce
...
This workflow consists of 43 nodes with the following execution flow:

1. **Trigger**: Workflow starts with @n8n/n8n-nodes-langchain.chatTrigger, n8n-nodes-base.manualTrigger
2. **Processing**: Data flows through 41 processing nodes
