# Usage Guide: Build an MCP Server with Google Calendar
...
1. **Trigger**: Workflow starts with @n8n/n8n-nodes-langchain.mcpTrigger, @n8n/n8n-nodes-langchain.chatTrigger
