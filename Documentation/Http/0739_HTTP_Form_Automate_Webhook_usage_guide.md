# Usage Guide: Streamline Your Zoom Meetings with Secure, Automated Stripe Payments
...
1. **Trigger**: Workflow starts with n8n-nodes-base.formTrigger, n8n-nodes-base.stripeTrigger
2. **Processing**: Data flows through 38 processing nodes
3. **Integration**: Connects with Google, Google, Google, Stripe
