# Deployment Guide: Cocktail Recipe Sharing
...
- **bannerbearApi**: [Instructions for setting up bannerbearApi]
- **rocketchatApi**: [Instructions for setting up rocketchatApi]
