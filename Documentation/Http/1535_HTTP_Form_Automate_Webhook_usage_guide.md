# Usage Guide: 💥🛠️Automate Blog Content Creation with GPT-4, Perplexity & WordPress
...
1. **Trigger**: Workflow starts with @n8n/n8n-nodes-langchain.chatTrigger, n8n-nodes-base.formTrigger
