# Deployment Guide: Receive a Mattermost message when a user updates their profile on Facebook
...
- **facebookGraphAppApi**: [Instructions for setting up facebookGraphAppApi]
