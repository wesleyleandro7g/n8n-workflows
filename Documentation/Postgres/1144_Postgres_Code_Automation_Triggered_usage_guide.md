...
This workflow consists of 31 nodes with the following execution flow:

1. **Trigger**: Workflow starts with n8n-nodes-base.googleDriveTrigger, n8n-nodes-base.executeWorkflowTrigger, @n8n/n8n-nodes-langchain.manualChatTrigger
