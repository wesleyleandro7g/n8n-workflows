# Usage Guide: RAG & GenAI App With WordPress Content
...
This workflow consists of 80 nodes with the following execution flow:

1. **Trigger**: Workflow starts with n8n-nodes-base.manualTrigger, n8n-nodes-base.respondToWebhook, n8n-nodes-base.scheduleTrigger, @n8n/n8n-nodes-langchain.chatTrigger
2. **Processing**: Data flows through 76 processing nodes
