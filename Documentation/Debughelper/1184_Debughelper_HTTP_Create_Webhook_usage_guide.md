# Usage Guide: Build your first AI MCP Server
...
1. **Trigger**: Workflow starts with @n8n/n8n-nodes-langchain.mcpTrigger, n8n-nodes-base.executeWorkflowTrigger, @n8n/n8n-nodes-langchain.chatTrigger, @n8n/n8n-nodes-langchain.mcpTrigger
2. **Processing**: Data flows through 44 processing nodes
